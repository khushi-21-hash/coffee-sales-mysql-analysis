...
-- How many orders included each product?
...
-- Sales growth rate
-- Calculate the percentage growth (or decline) in sales over 
...
SELECT * ,
   round(( total_monthly_sales - previous_month_sales
        ) * 100.0
        / previous_month_sales,2) as growth_percent
        from sales_growth
